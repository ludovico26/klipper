...
class CartKinematics:
    def __init__(self, toolhead, config):
        ...
        gcode.register_mux_command("SET_MY_STEP_DISTANCE", "STEPPER",
                                   self.name, self.cmd_MY_STEP_DISTANCE,
                                   desc=self.cmd_MY_STEP_DISTANCE_help)
    ...
    cmd_MY_STEP_DISTANCE_help = "Set extruder step distance"
    def cmd_MY_STEP_DISTANCE(self, gcmd):
        toolhead = self.printer.lookup_object('toolhead')
